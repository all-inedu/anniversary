                                ...
                                <section class="active" id="section_1">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="{{ url('/') }}" type="button"
                                            class="btn text-danger bg-white"><i class="bi bi-arrow-left"></i> Back
                                        </a>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 mb-2" id="grade_input">
                                            ...
                                            <label for="" class="label-role parent d-none">What grade is your
                                                child in?</label>
                                            <select name="grade" class="select w-100 field field-1" id="grade"
                                                onchange="is_filled('grade')">
                                                <option></option>
                                                @for ($i = 7; $i <= 12; $i++)
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <label for="" class="label-role parent d-none">What school is he/she
                                                going to graduate from?</label>
                                            <label for="" class="label-role teacher d-none">What school are you
                                                from?</label>
                                            ...
                                            <input type="text" name="school_other"
                                                class="form-control mt-1 d-none" id="school_other">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="label-role student">Where's your country destination to study
                                                abroad?</label>
                                            <label class="label-role parent d-none">In what country does he/she want to study
                                                abroad?
                                        ...
                                        <div class="col-md-12 mb-2" id="major_input">
                                            ...
                                            <label for="" class="label-role parent d-none">What is your child's
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label for="" class="label-role student">Whats your biggest
                                                ...
                                                university?</label>
                                            <label for="" class="label-role parent d-none">What is your biggest
                                                challenge in helping your children preparing for university?</label>
                                            <label for="" class="label-role teacher d-none">What is your biggest
                                                challenge in helping your students preparing for university?</label>
                                            <select name="challenge" class="select w-100 field field-6"
                                            ...
                                            <input type="text" name="challenge_other"
                                                class="form-control mt-1 d-none" id="challenge_other">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <button type="button" class="btn text-danger bg-white"
                                            onclick="goSection(1)"><i class="bi bi-arrow-left"></i> Back </button>
